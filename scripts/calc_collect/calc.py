...
def get_initial_setup_data():
  ...
  while date < yesterday:
    ...
    #
    # Calculating records per date.
    #
    calculate_funnel_data(date, 'd')
    calculate_funnel_data(date, 'w')

    #
    # The following is causing an unknown bug.
    #
    #data.extend(calculate_funnel_data(date, 'm'))
    #data.extend(calculate_funnel_data(date, 'q'))
    #data.extend(calculate_funnel_data(date, 'y'))
