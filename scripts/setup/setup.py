...
def CollectPreviousGAData(verbose = False, test_data = False):
...
def CollectPreviousCKANData(test_data = False):
...
def Main():
  ...
  CollectPreviousGAData()
  CollectPreviousCKANData()

  # Running historic calculations.
  RunHistoricalCalculation()
